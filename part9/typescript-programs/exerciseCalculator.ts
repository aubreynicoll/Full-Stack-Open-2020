...
// export const parseExerciseArguments = (args: Array<string>): ExerciseArgs => {
...
export const exerciseCalculator = (exerciseArray: Array<number>, exerciseGoal: number): ExerciseData => {
